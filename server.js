...
const validateComment = (url, request) => {
...
//return 400 if required field not supplied - think it's something like the above inserted into the below
...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    ...
    //for every user in the database remove deleted comment
    ...
    //for every article in the database remove deleted comment
...
saveDatabase = yaml('myData.yml', database);
//loadDatabase = yaml.load('myData.yml');
